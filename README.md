...
Module id: `soundscape-processors` · Current version: **2.0.0-beta.16**
...
Install the built package into Companion’s modules folder (or use a local module path), then select version `2.0.0-beta.16` on the connection.
...
- **2.0.0-beta.16.1** — Rename module to "d&b audiotechnik Soundscape Processors"
- **2.0.0-beta.16** — Stream Deck rotary presets (Gain/Delay/SOR/Spread/Position X/Y)
